...
cvars.AddChangeCallback("AdvDupe2_SpawnRate", function(cvar, preval, newval)
...
local function PasteMap()
    if not GetConVar("AdvDupe2_LoadMap"):GetBool() then return end
    local filename = GetConVar("AdvDupe2_MapFileName"):GetString()
    ...
    local maptype = GetConVar("AdvDupe2_LoadMap"):GetString()
...
hook.Add("Initialize", "AdvDupe2_CheckServerSettings", function()
    AdvDupe2.SpawnRate = GetConVar("AdvDupe2_SpawnRate"):GetInt()
